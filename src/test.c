...
START_TEST(s21_is_greater_6) {
  ...
  s21_decimal value_2 = {{123456, 1, 0, 0}};
...
START_TEST(s21_sub_15) {
  ...
  s21_decimal res = {0};
  s21_decimal res2 = {{50, 0, 0, 0}};
  s21_set_sign(&a, 1);
  s21_set_sign(&b, 1);
  s21_set_sign(&res2, 1);
  s21_sub(a, b, &res);
  for (int i = 0; i < 4; i++) ck_assert_int_eq(res.bits[i], res2.bits[i]);
}
END_TEST
...
START_TEST(s21_div_2) {
  ...
  // s21_decimal result_2 = {{50, 0, 0, 0}};
  s21_div(value_1, value_2, &result_1);
  float result_float = 0;
  s21_from_decimal_to_float(result_1, &result_float);
  // printf("float = %f\n", result_float);
...
START_TEST(s21_mul_test_28) {
  ...
  s21_decimal b = {{1, 0, 0, 0}};   // 0.0000000000000000000000000001
  s21_decimal res_bits = {{0, 0, 0, 0}};
...
START_TEST(s21_from_float_to_decimal_4) {
  ...
  float num2;
  s21_decimal res1 = {0};
  s21_from_float_to_decimal(num, &res1);
  s21_from_decimal_to_float(res1, &num2);
  ck_assert_float_eq(num, num2);
}
END_TEST
...
START_TEST(s21_from_float_to_decimal_12) {
  ...
  s21_from_float_to_decimal(num, &res1);
  s21_from_decimal_to_float(res1, &num2);
  ck_assert_float_eq(-12345678, num2);
}
END_TEST
